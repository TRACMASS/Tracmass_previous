...
contains
  ...
  subroutine  pos(ia,iam,ja,ka,ib,jb,kb,x0,y0,z0,x1,y1,z1)
    ...
    elseif(ds==dsu) then ! upward grid-cell exit
       ...
       z1=dble(ka)
       if(kb==KM+1) then   
          ! prevent "evaporation" and put particle from the surface
          ! to the middle of the surface layer
          kb=KM           
          z1=dble(KM)-0.5d0
       endif
#if defined timeanalyt
