...
MODULE mod_tempsalt
  ...
  REAL(SP), ALLOCATABLE, DIMENSION(:,:,:,:) :: tem,sal,rho
  REAL(SP)                                  :: tmin0 ,tmax0
  REAL(SP)                                  :: smin0 ,smax0
  REAL(SP)                                  :: rmin0 ,rmax0
  REAL(SP)                                  :: tmine ,tmaxe
...
MODULE mod_grid
  ...
  REAL(SP), ALLOCATABLE, DIMENSION(:,:,:)   :: hs
  REAL(SP), ALLOCATABLE, DIMENSION(:,:,:)   :: botbox
  REAL(SP), ALLOCATABLE, DIMENSION(:,:)     :: dxv, dyu, ang
...
MODULE mod_vel
  ...
  USE mod_precdef
  REAL(SP), ALLOCATABLE, DIMENSION(:,:,:,:)    :: uflux, vflux
...
MODULE mod_streamfunctions
  USE mod_precdef
#ifdef streamxy
  REAL(SP), ALLOCATABLE, DIMENSION(:,:,:)        :: stxyy, stxyx
#endif
#ifdef streamv
  REAL(SP), ALLOCATABLE, DIMENSION(:,:,:)        :: stxz, styz
#endif
#ifdef streamr
  REAL(SP), ALLOCATABLE, DIMENSION(:,:,:,:)      :: stxr,styr
#endif
