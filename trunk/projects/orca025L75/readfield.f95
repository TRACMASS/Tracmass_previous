...
! === Find the file for this timestep ===
 ...
 dataprefix='xxxx/ORCA025L75-SLB2_6h_yxxxx_dxxx-xxx_grid_'
 write(dataprefix(1:4),'(i4)') currYear
 write(dataprefix(26:29),'(i4)') currYear
 print *,'dataprefix=',dataprefix,currday,julian
