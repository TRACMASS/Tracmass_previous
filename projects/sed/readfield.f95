...
character ofile*17,infile*40,zfile*120,rfile*35
character*3 a_exp1
character*2 a_exp2
logical around
...
open (unit=86,file='/Volumes/sjo1/data/rco/kmt',form='unformatted')
read (86) kmt
close (86)
...
!      infile='/net/navier/zee3/data/rco/'//ofile
      infile='/Volumes/sjo1/data/rco/'//ofile
!      print *,infile
!     zfile='uncompress -c '//infile//
zfile='gunzip -c '//infile//'.Z > /Volumes/sjo1/data/rco/tmp/'//name
!      print *,zfile
!      stop 50789
!      zfile='uncompress '//infile//'.Z'
      CALL system(zfile)
      rfile='/Volumes/sjo1/data/rco/tmp/'//name
!      print *,rfile
!      stop 49567
